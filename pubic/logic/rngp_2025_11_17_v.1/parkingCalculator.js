...
class ParkingCalculator {
    ...
    getFormattedReport() {
        ...
        // Постоянные места - только если есть жилье
        ...
        // Приобъектные места - только если есть коммерция
        ...
        // Места остановки - только если есть жилье или коммерция
        ...
        // Итого - только если есть хоть какие-то данные
        ...
        // Школа и детсад - только если есть данные
